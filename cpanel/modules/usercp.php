...
<div class="glassmorphism rounded-2xl p-6 shadow-xl mb-6 fade-in">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-xl font-bold text-slate-900 mb-2">UserCP Menu Items</h2>
            <p class="text-slate-600">Manage the navigation items displayed in the User Control Panel</p>
        </div>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-white/20">
                ...
                <tr class="menu-item-row">
                    <form action="?module=usercp" method="post">
                        ...
                        <td class="py-4 px-4">
                            <input type="hidden" name="usercp_id" value="<?php echo htmlspecialchars($id); ?>">
                            <input type="number" name="usercp_order" value="<?php echo htmlspecialchars($item['order']); ?>" min="1" class="form-input w-16">
                        </td>
                        <td class="py-4 px-4">
                            <div class="radio-group">
                                <label class="radio-option">
                                    <input type="radio" name="usercp_status" value="1" <?php echo ($item['active'] ? 'checked' : ''); ?>>
                                    <span class="text-sm">Show</span>
                                </label>
                                <label class="radio-option">
                                    <input type="radio" name="usercp_status" value="0" <?php echo (!$item['active'] ? 'checked' : ''); ?>>
                                    <span class="text-sm">Hide</span>
                                </label>
                            </div>
                        </td>
                        <td class="py-4 px-4">
                            <select name="usercp_type" class="form-select">
                        ...
                        <td class="py-4 px-4">
                            <input type="text" name="usercp_link" value="<?php echo htmlspecialchars($item['link']); ?>" class="form-input w-full">
                        </td>
                        <td class="py-4 px-4">
                            <input type="text" name="usercp_phrase" value="<?php echo htmlspecialchars($item['phrase']); ?>" class="form-input w-full">
                        </td>
                        <td class="py-4 px-4">
                            <input type="text" name="usercp_icon" value="<?php echo htmlspecialchars($item['icon']); ?>" class="form-input w-full">
                        </td>
                        <td class="py-4 px-4">
                            <select name="usercp_visibility" class="form-select">
                        ...
                        <td class="py-4 px-4">
                            <div class="radio-group">
                                <label class="radio-option">
                                    <input type="radio" name="usercp_newtab" value="1" <?php echo ($item['newtab'] ? 'checked' : ''); ?>>
                                    <span class="text-sm">Yes</span>
                                </label>
                                <label class="radio-option">
                                    <input type="radio" name="usercp_newtab" value="0" <?php echo (!$item['newtab'] ? 'checked' : ''); ?>>
                                    <span class="text-sm">No</span>
                                </label>
                            </div>
                        </td>
                        <td class="py-4 px-4">
                            <button type="submit" name="usercp_submit" value="ok" class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl hover:from-green-600 hover:to-emerald-700 transition-all shadow-lg text-sm">
                ...
                <tr class="menu-item-row bg-blue-50/30">
                    <form action="?module=usercp" method="post">
                        ...
                        <td class="py-4 px-4">
                            <input type="number" name="usercp_order" value="10" min="1" class="form-input w-16">
                        </td>
                        <td class="py-4 px-4">
                            <div class="radio-group">
                                <label class="radio-option">
                                    <input type="radio" name="usercp_status" value="1" checked>
                                    <span class="text-sm">Show</span>
                                </label>
                                <label class="radio-option">
                                    <input type="radio" name="usercp_status" value="0">
                                    <span class="text-sm">Hide</span>
                                </label>
                            </div>
                        </td>
                        ...
                        <td class="py-4 px-4">
                            <input type="text" name="usercp_link" placeholder="Enter link URL" class="form-input w-full">
                        </td>
                        <td class="py-4 px-4">
                            <input type="text" name="usercp_phrase" placeholder="Language phrase key" class="form-input w-full">
                        </td>
                        <td class="py-4 px-4">
                            <input type="text" name="usercp_icon" placeholder="Icon name" class="form-input w-full">
                        </td>
                        <td class="py-4 px-4">
                            <select name="usercp_visibility" class="form-select">
                        ...
                        <td class="py-4 px-4">
                            <div class="radio-group">
                                <label class="radio-option">
                                    <input type="radio" name="usercp_newtab" value="1">
                                    <span class="text-sm">Yes</span>
                                </label>
                                <label class="radio-option">
                                    <input type="radio" name="usercp_newtab" value="0" checked>
                                    <span class="text-sm">No</span>
                                </label>
                            </div>
                        </td>
...
<div class="glassmorphism rounded-2xl p-6 shadow-xl mb-6">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-xl font-bold text-slate-900 mb-2">UserCP Menu Preview</h2>
    ...
    <div class="bg-white/80 rounded-xl p-6 shadow-inner">
        <div class="flex flex-col gap-1" id="preview-container">
            <?php 
            ...
            <div id="user-preview" class="preview-view">
                ...
                <div class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-blue-50 transition-colors">
                    <i data-lucide="<?php echo str_replace('.png', '', $item['icon']); ?>" class="w-5 h-5 text-blue-600"></i>
                    <span class="font-medium"><?php echo htmlspecialchars($item['phrase']); ?></span>
                    <?php if($item['newtab']): ?>
...
<script>
    ...
    function confirmAction() {
        if (currentAction === 'delete' && currentItemId) {
            window.location.href = '?module=usercp&delete=' + encodeURIComponent(currentItemId);
            return;
    ...
    function saveMenuItem(itemId) {
        const form = document.querySelector('input[name="usercp_id"][value="'+itemId+'"]')?.closest('form');
        if(form) form.submit();
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        console.log('UserCP Menu Configuration initialized');
    });
</script>